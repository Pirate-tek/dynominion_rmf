...
This package is used to publish messages in the topic **/cmd_vel** of type **geometry_msgs/msg/TwistStamped**, which act as control commands for the Dynominion_rmf robot.
