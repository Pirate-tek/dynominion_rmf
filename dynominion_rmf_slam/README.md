...
The dynominion_rmf_slam package enables SLAM Toolbox–based mapping for the Dynominion_rmf robot. It provides both online and offline mapping capabilities to support flexible and efficient map generation.

This package integrates SLAM Toolbox with the Dynominion_rmf robot to perform simultaneous localization and mapping. 
...
```bash
ros2 launch dynominion_rmf_slam online_sync_launch.py
```
...
```bash
ros2 launch dynominion_rmf_slam offline_launch.py
```
