...
def generate_launch_description():
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        'rviz_config',
        default_value=os.path.join(get_package_share_directory("dynominion_rmf_slam"),
                                   'rviz', 'mapping.rviz'),
        description='Rviz config needs to be in the dynominion_rmf_slam package config ')
    ...
    laser_filter_node =  Node(
            ...
            parameters=[
                os.path.join(
                    get_package_share_directory("dynominion_rmf_slam"),
